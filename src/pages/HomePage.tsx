      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 text-white py-32 px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect width="100%" height="100%" fill="url(#cross-pattern-hero)" />
          </svg>
        </div>
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto">
          ...
          <div className="flex justify-center mb-6">
            <div className="w-24 h-24 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center shadow-2xl border-4 border-white/20">
              <svg
